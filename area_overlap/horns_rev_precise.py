...
turb_data = open('turb17_jensen2.dat', 'w')
direction = open('direction_efficiency_jensen_precise.dat', 'w')
...
def analysis():
    ...
    # for wind in range(180-2, 180+3):
        ...
        for turbine in range(0, nt):
            ...
            for i in range(nt):
                if i != turbine:
                    proportion[i][turbine] = wake.determine_if_in_wake(layout_x[turbine], layout_y[turbine], layout_x[i], layout_y[i], k, r0, angle3)
                elif i == turbine:
