from wisdem.lcoe.lcoe_csm_2015_assembly import lcoe_se_assembly
...
lcoe = lcoe_se_assembly(with_new_nacelle=True, with_landbos=False, flexible_blade=False, with_3pt_drive=False, with_ecn_opex=False, ecn_file=None)
